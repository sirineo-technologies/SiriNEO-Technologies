...
## Conheça nossa Startup SiriNEO Technologies - ANO 2025 !
...
Desenvolvemos hardwares para aplicação em iot e estamos em processo de lançamento de nossas Plataformas de Hardwares: JARM IOT M (ARM CORTEX M0), JARM ESP32 IOT (ESP32 WROOM) e SiriNEO GeoTRACKER (ARM CORTEX M0). Para o Raspberry Pi desenvolvemos o Hat GongoMESH, para aplicações como treinamento e programação e também como Gateway utilizando protocolos como LoRa, Zigbee, Wi-Fi, BLE, GPRS, NB-IOT e SigFOX.
...
para se ligar com displays epaper do mercado nos modelos: [1.54inch E-Ink display module] (https://www.waveshare.com/1.54inch-e-paper-module.htm?amazon), [2.9inch E-Paper E-Ink Display Module (B)](https://www.waveshare.com/pico-epaper-2.9-b.html) e [2.66inch E-Paper E-Ink Display Module (B)](https://www.waveshare.com/2.66inch-e-paper-module-B.html). 
...
|     :---:    |     :---:      |     :---:      |    
| Case JARMs   | Case GongoMESH  | CaseBOX  ABS   |    

## Programas que já reconheram e certificaram nosso trabalho

|  [<img src="http://sirineotechnologies.com/wp-content/uploads/2022/03/inovativa_novo-logo.png" width=200 > <br> <sub>  </sub>](https://www.inovativa.online/)   | [<img src="http://sirineotechnologies.com/wp-content/uploads/2022/03/nexus-2.png" width=130> <br> <sub>  </sub>](https://pqtec.org.br/nexus/)   |   
|     :---:    |     :---:      |     
